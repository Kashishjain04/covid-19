<!-- <footer class="bg-white sticky-footer">
        ...
        <?php $toggle && echo('<button style="top:5rem;" class="border rounded d-inline scroll-to-top" onclick="toggle()"><i id="mode-toggle" class="fa fa-sun-o" aria-hidden="true"></i></button>')?>
