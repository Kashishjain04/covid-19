        ...
        <div class="table-responsive">
          <table id="example" style="width:100%; border-collapse: inherit;" class="table table table-striped table-bordered">
            ...
            ?>
                <tr>
                  <div class=row>
                    <td style="font-size: x-large; text-align: center;"><b><?= $key ?></b></td>
                    <td>
                      <div class="col-auto">
                        <span class="row" style="font-size: smaller; font-weight: 700; color: #ed3838;">
                          <?php if ($dc) {
                            echo $dc;
                          } ?>
                        </span>
                        <span class="row comp"><?= $c ?></span>
                      </div>
                    </td>
                    <td>
                      <div class="col-auto">
                        <span class="row" style="font-size: smaller; font-weight: 700; color: #1579f6;">
                          <?php if ($da) {
                            echo $da;
                          } ?>
                        </span>
                        <span class="row comp"><?= $a ?></span>
                      </div>
                    </td>
                    <td>
                      <div class="col-auto">
                        <span class="row" style="font-size: smaller; font-weight: 700; color: #4ca746;">
                          <?php if ($dr) {
                            echo $dr;
                          } ?>
                        </span>
                        <span class="row comp"><?= $r ?></span>
                      </div>
                    </td>
                    <td>
                      <div class="col-auto">
                        <span class="row" style="font-size: smaller; font-weight: 700; color: #6c757c;">
                          <?php if ($dd) {
                            echo $dd;
                          } ?>
                        </span>
                        <span class="row comp"><?= $d ?></span>
                      </div>
                    </td>
                    <td>
                      <div class="col-auto">
              ...
              $distdaily = file_get_contents('https://api.covid19india.org/v4/data-'.$now.'.json');
              $distdaily = json_decode($distdaily, true);              
              foreach ($distdaily as $key => $state) {                                
                if ($scode[$key] != $name) {
                      continue;
                    }                
                foreach($state['districts'] as $dname => $District) {
                ...
                ?>
                  <tr>
                    <div class=row>
                      <td style="font-size: x-large; text-align: center;"><b><?= $dname ?></b></td>
                      <td>
                        <div class="col-auto">
                          <span class="row" style="font-size: smaller; font-weight: 700; color: #ed3838;">
                            <?php if ($dc) {
